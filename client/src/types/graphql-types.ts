...
export function useGetAllTeamsQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetAllTeamsQuery, GetAllTeamsQueryVariables>(
    GetAllTeamsDocument,
    options
  );
}
...
export function useGetAllTeamsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetAllTeamsQuery,
  ...
  const options =
    baseOptions === Apollo.skipToken
      ? baseOptions
      : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<GetAllTeamsQuery, GetAllTeamsQueryVariables>(
    GetAllTeamsDocument,
    options
  );
}
export type GetAllTeamsQueryHookResult = ReturnType<typeof useGetAllTeamsQuery>;
export type GetAllTeamsLazyQueryHookResult = ReturnType<
  typeof useGetAllTeamsLazyQuery
>;
export type GetAllTeamsSuspenseQueryHookResult = ReturnType<
  typeof useGetAllTeamsSuspenseQuery
>;
...
export function useGetAllCompetitionsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    ...
    GetAllCompetitionsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetAllCompetitionsQuery,
    GetAllCompetitionsQueryVariables
  >(GetAllCompetitionsDocument, options);
}
...
export function useGetAllCompetitionsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        GetAllCompetitionsQuery,
...
>;
export type GetAllCompetitionsSuspenseQueryHookResult = ReturnType<
  typeof useGetAllCompetitionsSuspenseQuery
>;
